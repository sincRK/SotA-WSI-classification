...
#SBATCH --job-name=download_histai_skinb1
#SBATCH --output=download_histai_skinb1.out
#SBATCH --error=download_histai_skinb1.err
...
huggingface-cli download histai/HISTAI-skin-b1 --repo-type dataset --local-dir ${ROOT_DIR}/skin-b1/
