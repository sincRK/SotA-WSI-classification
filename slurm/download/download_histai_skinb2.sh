...
#SBATCH --job-name=download_histai_skinb2
#SBATCH --output=download_histai_skinb2.out
#SBATCH --error=download_histai_skinb2.err
...
huggingface-cli download histai/HISTAI-skin-b2 --repo-type dataset --local-dir ${ROOT_DIR}/skin-b2/
