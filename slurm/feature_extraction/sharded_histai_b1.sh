...
which python
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/skin-b1 ${TMPDIR}/histai_skin_b1_features 8 5 seg uni_v2 20x 512
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/skin-b1 ${TMPDIR}/histai_skin_b1_features 8 5 seg uni_v2 20x 256
