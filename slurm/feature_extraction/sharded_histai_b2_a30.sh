...
which python
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/skin-b2 ${TMPDIR}/histai_skin_b2_features 8 5 seg uni_v2 20x 512
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/skin-b2 ${TMPDIR}/histai_skin_b2_features 8 5 seg uni_v2 20x 256
