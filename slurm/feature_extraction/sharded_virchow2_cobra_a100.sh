...
# virchow_2 - 1:30h x 4
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${BENCH}/cobra/packages/ood/images/ ${TMPDIR}/cobra_features 3 14 feat virchow2 20 512 128 ${TMPDIR}/cobra_features/20x_512px_0px_overlap/
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${BENCH}/cobra/packages/ood/images/ ${TMPDIR}/cobra_features 3 14 feat virchow2 20 256 128 ${TMPDIR}/cobra_features/20x_256px_0px_overlap/
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${BENCH}/cobra/packages/ood/images/ ${TMPDIR}/cobra_features 3 14 feat virchow2 10 512 128 ${TMPDIR}/cobra_features/10x_512px_0px_overlap/
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${BENCH}/cobra/packages/ood/images/ ${TMPDIR}/cobra_features 3 14 feat virchow2 10 256 128 ${TMPDIR}/cobra_features/10x_256px_0px_overlap/
