...
which python
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/images ${TMPDIR}/cobra_features 5 20 seg uni_v2 20x 512
bash ${TMPDIR}/feature_extraction/feature_extraction_sharded.sh ${TMPDIR}/images ${TMPDIR}/cobra_features 5 20 seg uni_v2 20x 256
